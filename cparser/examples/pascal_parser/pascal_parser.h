...
typedef enum {
  ...
  PASCAL_T_RECORD_CONSTRUCTOR, // Record constructor: (field: value; field:
                               // value)
  ...
  PASCAL_T_END_BLOCK,
  PASCAL_T_FOR_STMT,
  PASCAL_T_FOR_IN_STMT,
  PASCAL_T_WHILE_STMT,
  PASCAL_T_REPEAT_STMT,
  PASCAL_T_WITH_STMT,
  PASCAL_T_WITH_CONTEXTS,
  PASCAL_T_LABEL_STMT,
  PASCAL_T_GOTO_STMT,
  PASCAL_T_DO,
  PASCAL_T_TO,
  ...
  PASCAL_T_OBJECT_TYPE, // Legacy object type (similar to record but with
                        // methods)
  ...
  PASCAL_T_TYPE_PARAM,        // Single type parameter like T
  PASCAL_T_TYPE_CONSTRAINT,   // Type constraint like T: class
  PASCAL_T_CONSTRUCTED_TYPE,  // Constructed type like TFoo<Integer>
  PASCAL_T_TYPE_ARG_LIST,     // Type argument list like <Integer, String>
  PASCAL_T_TYPE_ARG,          // Single type argument like Integer
  PASCAL_T_GENERIC_METHOD,    // Generic method declaration
  PASCAL_T_GENERIC_PROCEDURE_TYPE, // Generic procedure type
  PASCAL_T_GENERIC_FUNCTION_TYPE,  // Generic function type
  PASCAL_T_NESTED_TYPE_SECTION,    // Nested type section in class body
  ...
  PASCAL_T_FIELD_DECL,
  PASCAL_T_VARIANT_TAG,
  PASCAL_T_VARIANT_BRANCH,
  PASCAL_T_VARIANT_PART,
...
combinator_t *pascal_identifier(
    tag_t tag); // Pascal identifier that excludes reserved keywords
