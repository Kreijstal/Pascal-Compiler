...
static bool read_word_at(const input_t *in, int pos,
...
bool pascal_peek_word_after(const input_t *in, int pos,
                            pascal_word_slice_t *slice) {
...
bool pascal_word_equals_ci(const pascal_word_slice_t *slice,
                           const char *keyword) {
