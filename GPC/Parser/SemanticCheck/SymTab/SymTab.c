...
int AddBuiltinProc(SymTab_t *symtab, char *id, ListNode_t *args)
{
    ...
    return AddIdentToTable(symtab->builtins, id, NULL, NULL, HASHTYPE_BUILTIN_PROCEDURE, args);
}
...
int AddBuiltinType(SymTab_t *symtab, char *id, Type_t *type)
{
    ...
    return AddIdentToTable(symtab->builtins, id, NULL, type, HASHTYPE_TYPE, NULL);
}
...
int PushVarOntoScope(SymTab_t *symtab, Type_t *type, char *id)
{
    ...
    if(FindIdentInTable(symtab->builtins, id) == NULL)
    {
        ...
        return AddIdentToTable(cur_hash, id, NULL, type, HASHTYPE_VAR, NULL);
    }
    else
    {
        return 1;
...
int PushArrayOntoScope(SymTab_t *symtab, Type_t *type, char *id)
{
    ...
    {
        cur_hash = (HashTable_t *)symtab->stack_head->cur;
        return AddIdentToTable(cur_hash, id, NULL, type, HASHTYPE_ARRAY, NULL);
    }
    else
    {
        return 1;
...
int PushProcedureOntoScope(SymTab_t *symtab, char *id, char *mangled_id, ListNode_t *args)
{
    ...
    {
        cur_hash = (HashTable_t *)symtab->stack_head->cur;
        return AddIdentToTable(cur_hash, id, mangled_id, NULL, HASHTYPE_PROCEDURE, args);
    }
    else
    {
        return 1;
...
int PushFunctionOntoScope(SymTab_t *symtab, char *id, char *mangled_id, Type_t *type, ListNode_t *args)
{
    ...
    {
        cur_hash = (HashTable_t *)symtab->stack_head->cur;
        return AddIdentToTable(cur_hash, id, mangled_id, type, HASHTYPE_FUNCTION, args);
    }
    else
    {
        return 1;
...
int PushFuncRetOntoScope(SymTab_t *symtab, char *id, Type_t *type, ListNode_t *args)
{
    ...
    {
        cur_hash = (HashTable_t *)symtab->stack_head->cur;
        return AddIdentToTable(cur_hash, id, NULL, type, HASHTYPE_FUNCTION_RETURN, args);
    }
    else
    {
        return 1;
...
int PushTypeOntoScope(SymTab_t *symtab, char *id, Type_t *type)
{
    ...
    {
        cur_hash = (HashTable_t *)symtab->stack_head->cur;
        return AddIdentToTable(cur_hash, id, NULL, type, HASHTYPE_TYPE, NULL);
    }
    else
    {
        return 1;
