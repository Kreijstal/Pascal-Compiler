    ...
    int cname_flag, int overload_flag)
{
    ...
    new_tree->tree_data.subprogram_data.has_pascal_body = 1;
...
Tree_t *mk_vardecl(int line_num, ListNode_t *ids, int type, char *type_id, int is_var_param, int inferred_type, struct Statement *initializer)
{
    ...
    new_tree->tree_data.var_decl_data.is_alias_array = 0;
    new_tree->tree_data.var_decl_data.alias_array_is_dynamic = 0;
    new_tree->tree_data.var_decl_data.alias_array_start = 0;
    new_tree->tree_data.var_decl_data.alias_array_end = -1;
    new_tree->tree_data.var_decl_data.alias_element_type = UNKNOWN_TYPE;
    new_tree->tree_data.var_decl_data.alias_element_size = 4;
