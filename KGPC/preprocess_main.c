...
static void print_usage(const char *prog_name) {
  ...
  fprintf(stderr, "    --flatten-only Expand includes but keep "
                  "directives/branches intact\n");
...
int main(int argc, char **argv) {
   ...
   * expressions, so define FPUSOFT to prevent FPC RTL from using them in const
   * initializers. */
  ...
  pascal_preprocessor_define(preprocessor,
  ...
  pascal_preprocessor_define_const(preprocessor, "MaxFixedHeaderAndPayload",
                                   "544");
  pascal_preprocessor_define_const(preprocessor, "MaxVarHeaderAndPayload",
                                   "1048096");
  pascal_preprocessor_define_const(preprocessor, "CommonHeaderSize", "4");
  pascal_preprocessor_define_const(preprocessor, "MinFixedHeaderAndPayload",
                                   "16");
  pascal_preprocessor_define_const(preprocessor,
  ...
  pascal_preprocessor_define_const(preprocessor, "SizeIndexBits",
                                   "4"); /* 1 + trunc(ln(15)/ln(2)) = 4 */
  pascal_preprocessor_define_const(preprocessor, "SizeIndexMask",
                                   "15"); /* (1 << 4) - 1 = 15 */
  ...
  pascal_preprocessor_define_const(
      preprocessor, "VarSizesCount",
      "320"); /* VarSizeClassesCount * VarSizesPerClass = 10 * 32 */
  ...
  pascal_preprocessor_define_macro(preprocessor, "first_mm_imreg",
                                   "32"); /* $20 in hex */
  ...
  preprocessed =
      pascal_preprocess_buffer(preprocessor, input_file, source, strlen(source),
                               &preprocessed_length, &error_message);
