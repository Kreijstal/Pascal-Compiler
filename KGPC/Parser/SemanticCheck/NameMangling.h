...
/*
 * KgpcBuiltinTypeInfo — the canonical metadata for a single Pascal builtin type.
 *
 ...
 * now implemented in terms of this helper; future callers may adopt it directly.
 */
