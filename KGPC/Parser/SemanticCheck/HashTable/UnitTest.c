...
int main() {
  ...
  /* Note: Procedures should now use KgpcType with params, not separate args
   * parameter. This test is simplified since we're transitioning away from
   * legacy args field. */
  ...
  AddIdentToTable_Legacy(table, "legacy_var", NULL, HASHVAR_INTEGER,
                         HASHTYPE_VAR, NULL, NULL, NULL);
