...
/* Type helper registry - accessible from other SemCheck modules */
...
int semcheck_funccall(int *type_return,
    SymTab_t *symtab, struct Expression *expr, int max_scope_lev, int mutating);
/* Forward declarations - these functions are declared in SemCheck_Expr_Internal.h */
...
int semcheck_prepare_record_constructor_argument(Tree_t *formal_decl, struct Expression *arg_expr,
    SymTab_t *symtab, int max_scope_lev, int line_num);
/* Forward declarations - see SemCheck_Expr_Internal.h */
...
/* With context stack - accessible from other SemCheck modules */
WithContextEntry *with_context_stack = NULL;
size_t with_context_count = 0;
size_t with_context_capacity = 0;

/* Forward declaration - see SemCheck_Expr_Internal.h */
