...
static int semcheck_builtin_setlength(SymTab_t *symtab, struct Statement *stmt, int max_scope_lev)
{
    ...
    if (length_type != INT_TYPE && length_type != LONGINT_TYPE && length_type != INT64_TYPE)
    {
...
static int semcheck_builtin_strproc(SymTab_t *symtab, struct Statement *stmt, int max_scope_lev)
{
    ...
    if (value_type != INT_TYPE && value_type != LONGINT_TYPE && value_type != INT64_TYPE)
    {
...
static int semcheck_builtin_insert(SymTab_t *symtab, struct Statement *stmt, int max_scope_lev)
{
    ...
    if (index_type != INT_TYPE && index_type != LONGINT_TYPE && index_type != INT64_TYPE)
    {
...
static int semcheck_builtin_delete(SymTab_t *symtab, struct Statement *stmt, int max_scope_lev)
{
    ...
    if (count_type != INT_TYPE && count_type != LONGINT_TYPE && count_type != INT64_TYPE)
    {
...
static int semcheck_builtin_val(SymTab_t *symtab, struct Statement *stmt, int max_scope_lev)
{
    ...
    if (value_type != INT_TYPE && value_type != LONGINT_TYPE && value_type != INT64_TYPE && value_type != REAL_TYPE)
    {
        fprintf(stderr,
    ...
    if (code_type != INT_TYPE && code_type != LONGINT_TYPE && code_type != INT64_TYPE)
    {
...
static int semcheck_builtin_inc(SymTab_t *symtab, struct Statement *stmt, int max_scope_lev)
{
    ...
    if (target_type != INT_TYPE && target_type != LONGINT_TYPE && target_type != INT64_TYPE && !target_is_pointer)
    {
    ...
    int max_scope_lev, const char *display_name)
{
    ...
    if (value_type != INT_TYPE && value_type != LONGINT_TYPE && value_type != INT64_TYPE && value_type != CHAR_TYPE)
    {
...
static int semcheck_builtin_write_like(SymTab_t *symtab, struct Statement *stmt, int max_scope_lev)
{
    ...
    while (args != NULL)
    {
        ...
        if (expr_type != INT_TYPE && expr_type != LONGINT_TYPE && expr_type != INT64_TYPE && expr_type != STRING_TYPE && expr_type != BOOL && expr_type != POINTER_TYPE && expr_type != REAL_TYPE && expr_type != CHAR_TYPE && expr_type != ENUM_TYPE)
        {
        ...
        if (expr != NULL && expr->field_width != NULL)
        {
            ...
            if (width_type != INT_TYPE && width_type != LONGINT_TYPE && width_type != INT64_TYPE)
            {
        ...
        if (expr != NULL && expr->field_precision != NULL)
        {
            ...
            if (precision_type != INT_TYPE && precision_type != LONGINT_TYPE && precision_type != INT64_TYPE)
            {
...
static int semcheck_builtin_read_like(SymTab_t *symtab, struct Statement *stmt, int max_scope_lev)
{
    ...
    while (args != NULL)
    {
        ...
        if (expr_type != INT_TYPE && expr_type != LONGINT_TYPE && expr_type != INT64_TYPE && expr_type != CHAR_TYPE && expr_type != STRING_TYPE && expr_type != REAL_TYPE)
        {
