                        ...
                        if (operator_method != NULL)
                        {
                            ...
                            if (operator_candidates != NULL)
                            {
                                ...
                                for (ListNode_t *cur = operator_candidates; cur != NULL; cur = cur->next)
                                {
                                    ...
                                    if (valid && match_quality > best_exact_score)
                                    {
                                        best_exact = candidate;
                                        best_exact_score = match_quality;
                                    }
                                }
                                if (best_exact != NULL)
