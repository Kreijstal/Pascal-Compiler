/*
    SemCheck_stmt_main.c - Main statement dispatch and assignment semantic checking

    Extracted from SemCheck_stmt.c. Contains semcheck_stmt_main, semcheck_varassign,
    semcheck_stmt, and property assignment functions.
*/
...
KgpcType *semcheck_get_current_subprogram_return_kgpc_type(SymTab_t *symtab, int *owned);
