...
static KgpcType *semcheck_create_value_kgpc_type_for_record_local(struct RecordType *record_info)
{
    if (record_info == NULL)
        return NULL;
...
static KgpcType *semcheck_create_value_kgpc_type_from_node_local(HashNode_t *type_node)
{
