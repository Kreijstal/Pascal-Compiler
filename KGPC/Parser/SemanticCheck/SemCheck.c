...
void semcheck_add_builtins(SymTab_t *symtab)
{
...

    {
        ...
        {
            /* Overload 1: SetCodePage(var S; CodePage) */
            ListNode_t *params_2 = NULL;
            ListNode_t *tail_2 = NULL;
            ListNode_t *param = NULL;

            param = semcheck_create_builtin_param_var("S", UNKNOWN_TYPE);
            if (param != NULL) {
                params_2 = param;
                tail_2 = param;
            }

            param = semcheck_create_builtin_param("CodePage", LONGINT_TYPE);
            if (param != NULL) {
                if (tail_2 != NULL)
                    tail_2->next = param;
                else
            ...
            KgpcType *type_2 = create_procedure_type(params_2, NULL);
            assert(type_2 != NULL && "Failed to create SetCodePage(2) procedure type");
            AddBuiltinProc_Typed(symtab, setcodepage_proc, type_2);
            destroy_kgpc_type(type_2);

            /* Overload 2: SetCodePage(var S; CodePage; Convert) */
            ListNode_t *params_3 = NULL;
            ListNode_t *tail_3 = NULL;
            ...
            param = semcheck_create_builtin_param("Convert", BOOL);
            if (param != NULL) {
                if (tail_3 != NULL)
                    tail_3->next = param;
                else
            ...
            KgpcType *type_3 = create_procedure_type(params_3, NULL);
            assert(type_3 != NULL && "Failed to create SetCodePage(3) procedure type");
            AddBuiltinProc_Typed(symtab, setcodepage_proc, type_3);
            destroy_kgpc_type(type_3);
