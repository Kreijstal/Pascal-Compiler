...
struct GenericTypeDecl {
  ...
  struct RecordType
      *record_template; // Cached record/class template for instantiation
...
// Represents a specialized instance of a generic type (e.g.,
// TFPGList<TMyRecord>)
...
// Asserts that a context is set — caller must guard with current_context() !=
// NULL.
