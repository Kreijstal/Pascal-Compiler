...
struct RecordType *codegen_lookup_record_type_for_node(SymTab_t *symtab, HashNode_t *node, const char *type_name);
...
long long codegen_class_var_storage_size(SymTab_t *symtab,
    const struct RecordType *record_info, int include_all_fields);
