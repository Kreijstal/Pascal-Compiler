...
int expr_tree_symbol_matches_expr_type(const HashNode_t *node, const struct Expression *expr);
HashNode_t *expr_tree_find_preferred_symbol(CodeGenContext *ctx, const struct Expression *expr);
...
ListNode_t *emit_alu_op_with_large_imm(ListNode_t *inst_list, CodeGenContext *ctx,
