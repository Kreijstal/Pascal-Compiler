...
int expr_is_single_real_with_symtab(const struct Expression *expr, SymTab_t *symtab)
{
 ...
 */
ListNode_t *emit_alu_op_with_large_imm(
...
ListNode_t *gencode_real_binary_op(CodeGenContext *ctx,
...
int expr_function_call_returns_ansistring(const struct Expression *expr, CodeGenContext *ctx)
{
...
int expr_is_shortstring_storage_ctx(const struct Expression *expr, CodeGenContext *ctx)
{
...
int expr_get_char_array_length_expr(const struct Expression *expr, CodeGenContext *ctx,
    long long *out_len)
{
    if (out_len != NULL)
        *out_len = 0;
...
ListNode_t *promote_shortstring_reg_operand(ListNode_t *inst_list, CodeGenContext *ctx,
...
ListNode_t *promote_shortstring_operand_ex(ListNode_t *inst_list, CodeGenContext *ctx,
