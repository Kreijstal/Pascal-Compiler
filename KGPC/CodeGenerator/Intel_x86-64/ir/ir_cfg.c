...
{
    static const char * const cond_mnems[] = {
        "je",  "jne", "jl",  "jle", "jg",  "jge",
        "jb",  "jbe", "ja",  "jae", "jz",  "jnz",
        "jc",  "jnc",
        NULL
    };
...
static BranchKind get_branch_kind(const char *text,
                                  char *target_out, int target_max)
{
...
static int block_array_init(BlockArray *ba)
{
    ...
    ba->blocks   = (BasicBlock_t **)calloc((size_t)ba->capacity,
                                           sizeof(BasicBlock_t *));
