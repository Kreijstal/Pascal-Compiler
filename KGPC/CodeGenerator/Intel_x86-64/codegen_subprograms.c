...
int add_absolute_static_symbol_alias(const char *alias_label, const char *target_symbol,
    int alias_size)
{
    if (alias_label == NULL || alias_label[0] == '\0' ||
...
int add_absolute_var_alias_with_offset(const char *alias_label, const char *target_label,
