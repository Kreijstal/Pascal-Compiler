/*
    Record access, pointer dereference, addressof, and set-literal emission for x86-64.
    Extracted from codegen_expression.c — see codegen_expression_internal.h for shared helpers.
*/
