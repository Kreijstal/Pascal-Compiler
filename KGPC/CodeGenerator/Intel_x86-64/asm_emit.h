 ...
 */
static inline void asm_emit_movq(char *buffer, size_t bufsize, const char *src,
                                 const char *dst) {
 ...
 */
static inline void asm_emit_movq_to_stack(char *buffer, size_t bufsize,
                                          const char *src_reg, int offset) {
 ...
 */
static inline void asm_emit_movq_from_stack(char *buffer, size_t bufsize,
                                            int offset, const char *dst_reg) {
 ...
 */
static inline void asm_emit_movl(char *buffer, size_t bufsize, const char *src,
                                 const char *dst) {
 ...
 */
static inline void asm_emit_movl_imm(char *buffer, size_t bufsize, int imm,
                                     const char *dst_reg) {
 ...
 */
static inline void asm_emit_movdqu_to_stack(char *buffer, size_t bufsize,
                                            const char *src_reg, int offset) {
 ...
 */
static inline void asm_emit_movdqu_from_stack(char *buffer, size_t bufsize,
                                              int offset, const char *dst_reg) {
 ...
 */
static inline void asm_emit_movabsq(char *buffer, size_t bufsize, long long imm,
                                    const char *dst_reg) {
 ...
 */
static inline void asm_emit_cmpq(char *buffer, size_t bufsize, const char *op1,
                                 const char *op2) {
 ...
 */
static inline void asm_emit_cmpq_stack(char *buffer, size_t bufsize,
                                       const char *reg, int offset) {
 ...
 */
static inline void asm_emit_cmpq_imm_stack(char *buffer, size_t bufsize,
                                           long long imm, int offset) {
 ...
 */
static inline void asm_emit_cmpl_imm_stack(char *buffer, size_t bufsize,
                                           long long imm, int offset) {
 ...
 */
static inline void asm_emit_cvtsi2sdq(char *buffer, size_t bufsize,
                                      const char *src_reg) {
 ...
 */
static inline void asm_emit_cvtsi2sdl(char *buffer, size_t bufsize,
                                      const char *src_reg) {
 ...
 */
static inline void asm_emit_leaq_rip(char *buffer, size_t bufsize,
                                     const char *label, const char *dst_reg) {
 ...
 */
static inline void asm_emit_leaq_stack(char *buffer, size_t bufsize, int offset,
                                       const char *dst_reg) {
