 ...
 *   - codegen_stmt_infrastructure.c  — register management, type helpers, expr
 * evaluation
 *   - codegen_stmt_assignment.c      — string/shortstring/array/record
 * assignment
 ...
 * (codegen_stmt, codegen_compound_stmt, etc.) and
 * codegen_stmt_calls_and_control.c (codegen_proc_call, codegen_var_assignment,
 * etc.).
 */
