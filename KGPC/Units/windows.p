...
{-------------------------------------------------------------------------}
{ Headless Win32 API wrappers via KGPC runtime (interface)                  }
{-------------------------------------------------------------------------}

function kgpc_get_tick_count64: culonglong; external name 'kgpc_get_tick_count64';
procedure kgpc_sleep_ms(milliseconds: cint32); external name 'kgpc_sleep_ms';
function kgpc_query_performance_counter: culonglong; external name 'kgpc_query_performance_counter';
function kgpc_query_performance_frequency: culonglong; external name 'kgpc_query_performance_frequency';
function kgpc_is_debugger_present: BOOL; external name 'kgpc_is_debugger_present';
...
function kgpc_windows_get_hostname_string: string; external;
function kgpc_windows_get_domainname_string: string; external;
function kgpc_get_tick_count64: culonglong; external;
procedure kgpc_sleep_ms(milliseconds: cint32); external;
...
function GetHostName: string;
begin
    GetHostName := kgpc_windows_get_hostname_string;
end;

function GetDomainName: string;
begin
    GetDomainName := kgpc_windows_get_domainname_string;
end;
...
procedure Sleep(milliseconds: DWORD); external name 'kgpc_sleep_ms';
