...
function Cos(Value: Real): Real; cdecl; external name 'fpc_in_cos_real';
...
function ArcTan(Value: Real): Real; cdecl; external name 'fpc_in_arctan_real';
...
function Exp(Value: Real): Real; cdecl; external name 'fpc_in_exp_real';
function Ln(Value: Real): Real; cdecl; external name 'fpc_in_ln_real';
...
function Round(Value: Real): Longint; cdecl; external name 'fpc_in_round_real';
function Trunc(Value: Real): Longint; cdecl; external name 'fpc_in_trunc_real';
function Int(Value: Real): Longint; cdecl; external name 'fpc_in_int_real';
function Frac(Value: Real): Real; cdecl; external name 'fpc_in_frac_real';
