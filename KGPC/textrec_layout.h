...
/*
 * KgpcTextRecLayout mirrors KGPCTextRec from runtime_internal.h field-for-field.
 * Use offsetof(KgpcTextRecLayout, <field>) to get compile-time field offsets.
 */
...
_Static_assert(offsetof(KgpcTextRecLayout, private_data) ==  16, "private_data offset");
...
_Static_assert(offsetof(KgpcTextRecLayout, inoutfunc)    ==  56, "inoutfunc offset");
_Static_assert(offsetof(KgpcTextRecLayout, flushfunc)    ==  64, "flushfunc offset");
_Static_assert(offsetof(KgpcTextRecLayout, closefunc)    ==  72, "closefunc offset");
