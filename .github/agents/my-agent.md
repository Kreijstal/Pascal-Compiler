...
No fallbacks or defensive programming, if a fallback is needed, then it is not a fallback it is a case and the assumptions, requirements, MUST be asserted, if you find a fallback, make them into cases (add assertions)
